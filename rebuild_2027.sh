...
echo "══ 1/4  Modèle de déviation par bureau → data/predictions_2027.csv"
...
echo "══ 2/4  Données servies (summary / circo / communes) + backtests + motif radical + γ"
python3 -u -m src.report_data_2027

echo "══ 3/4  Parité Python ↔ JavaScript (le site calcule-t-il le même modèle ?)"
...
echo "══ 4/4  Cohérence : aucun chiffre affiché n'est figé (doit venir des données servies)"
